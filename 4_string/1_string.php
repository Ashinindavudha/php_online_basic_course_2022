...
echo "hello " . "Mandalay"; // multiple concatenation . and PHP;
...
$invoiceNumber = 100;
$invoiceNumber_2 = 123456;

echo str_pad($invoiceNumber, 8, '0', STR_PAD_LEFT) . '<br>' . PHP_EOL;

echo str_pad($invoiceNumber_2, 8, '0', STR_PAD_LEFT) . '<br>' . PHP_EOL;

echo str_repeat('Hello', 2) . '<br>' . PHP_EOL . '<br>' . PHP_EOL;
